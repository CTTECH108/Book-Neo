        ...
        <div className="text-center">
          ...
          <div className="bg-gray-50 dark:bg-slate-700 rounded-xl p-4 mb-6">
            <div className="flex justify-between mb-2">
              ...
              <span className="font-semibold dark:text-white">{booking.bookingId}</span>
            </div>
            <div className="flex justify-between mb-2">
              <span className="text-sm text-gray-600 dark:text-gray-300">Guest:</span>
              <span className="font-semibold dark:text-white">{booking.guestName}</span>
            </div>
            <div className="flex justify-between mb-2">
              <span className="text-sm text-gray-600 dark:text-gray-300">Check-in:</span>
              <span className="font-semibold dark:text-white">{new Date(booking.checkInDate).toLocaleDateString()}</span>
            </div>
            <div className="flex justify-between mb-2">
              <span className="text-sm text-gray-600 dark:text-gray-300">Check-out:</span>
              <span className="font-semibold dark:text-white">{new Date(booking.checkOutDate).toLocaleDateString()}</span>
            </div>
          ...
          <div className="space-y-3">
            <Button onClick={downloadQRCode} className="w-full bg-gradient-to-r from-indigo-500 to-purple-500 text-white">
            ...
            <Button onClick={() => setLocation("/home")} variant="outline" className="w-full">
